...
const TemplateSelectionModal = ({
  ...
  const filteredTemplates = templates.filter((templates) => {
    const matchedSearches =
      templates.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
      templates.description.toLowerCase().includes(searchQuery.toLowerCase()) ||
      templates.tags.some((tag) =>
        tag.toLowerCase().includes(searchQuery.toLowerCase()),
      );

    const matchesCategory =
      category === "all" || templates.category === category;

    return matchesCategory && matchedSearches;
  });
