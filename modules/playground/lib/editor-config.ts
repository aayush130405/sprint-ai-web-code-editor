...
//Purpose: Map a file extension (e.g. "tsx", "py") to a Monaco language ID (e.g. "typescript", "python").
...
//Purpose: One-time setup when Monaco loads. You pass this to @monaco-editor/react’s beforeMount or onMount callback.
...
//Purpose: A plain object of Monaco editor options — the “feel” of the editor. Passed to <Editor options={defaultEditorOptions} />.
